...
it. Both modals share a common form component. Empty columns show a
placeholder instead of a blank gap. ESLint is set up and currently
passes clean. Still no backend — everything lives in the browser.
